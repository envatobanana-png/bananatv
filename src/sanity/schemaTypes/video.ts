...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      options: {
        list: [
          { title: 'Unreal Places Of China', value: 'china' },
          { title: 'Unreal Places Of China|Travel Video 4K', value: 'china4k' },
          { title: 'Banana Planet TV', value: 'banana' },
          { title: 'Natural Wonders', value: 'wonders' },
        ],
      },
    }),
    defineField({
